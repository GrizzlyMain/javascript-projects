...
while (astronautNum > 0 || astronautNum <= 7 || isNaN(astronautNum) ){
  astronautNum = input.question('How many astronnauts are going on the mission? ');
}

while (startingFuel-100*astronautNum >= 0) {
  altitude += 50;
  startingFuel -= 100*astronautNum;
  }
