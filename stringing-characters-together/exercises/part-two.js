...
console.log (String(dnaTwo).length);
...
console.log(`${dnaTwo.slice(4,7).toLowerCase()}o${dnaTwo.slice(1,2).toLowerCase()}${dnaTwo.slice(5,6).toLowerCase()}${dnaTwo.slice(4,5).toLowerCase()}`);
